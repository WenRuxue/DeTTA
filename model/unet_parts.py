...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        if bilinear:
            ...
            self.up_1 = nn.ConvTranspose2d(in_channels // 2, in_channels // 2, kernel_size=2, stride=2)
            self.up_2 = nn.ConvTranspose2d(in_channels, in_channels // 2, kernel_size=2, stride=2)
